...
Part.Part5 = Object.freeze(`@Ball:電腦需要儲存資料時
        ...
        @Ball:「true和false是什麼?」
        @Answer:boolean`);
Part.owo1 = Object.freeze(`@Ball:意思是電腦會用這個 「boolean」 
...
Part.Part8 = Object.freeze(`@Ball:我們還可以一次完成兩件事：
        ...
        @Answer:長相 名字 = 資料;`);
Part.owo2 = Object.freeze(`@Ball:這樣就直接建立了一個 isSunny 的空間
...
Part.Part10 = Object.freeze(`@Ball:電腦的加減乘除，基本上跟數學一樣
        ...
        @Code:q1
        @Answer:true`);
Part.owo3 = Object.freeze(`@Ball:括號也和數學裡一樣。
        @Ball:所以如果想改變計算的順序
        @Ball:就可以用括號把它包起來。
...
Part.Part11 = Object.freeze(`@Ball:電腦連大於、小於、大於或等於、小於或等於
        ...
        @Code:q8_1
        @Answer:false`);
Part.owo4 = Object.freeze(`@Ball:大於或等於：5 >= 5
...
Part.Part26 = Object.freeze(`@Ball:電腦也能根據我們的指令進行加法和減法。
        ...
        @Code:q16
        @Answer:11`);
Part.Part27 = Object.freeze(`@Code:minus
...
Part.Part28 = Object.freeze(`@Ball:還有乘法和除法都能照著數學規則來。
        ...
        @Code:q18
        @Answer:18`);
Part.Part29 = Object.freeze(`@Code:divide 
...
Part.Part30 = Object.freeze(`@Ball:我們還可以簡寫：a = a + 5; 可以寫成 a += 5;。
        ...
        @Code:q1
        @Answer:false`);
Part._final = Object.freeze(`@Ball:相信你一定有想過
        @Ball:如果我需要儲存一個變量
...
Part.Part31 = Object.freeze(`@Ball:class 就像生物分類裡的「屬」
        ...
        @Ball:「class是一個什麼?」
        @Answer:框架`);
Part.Part32 = Object.freeze(`@Ball:class在檔案當中儲存為.java文件
        @Ball:用資料夾分隔的叫做包(package)。
        @Ball:「用資料夾分隔的叫做?」
        @Answer:包`);
Part.Part33 = Object.freeze(`@Ball:一個class可以繼承 (在某class的下屬)
...
Part.Part34 = Object.freeze(`@Ball:Class內可以儲存方法或者變量
        @Ball:儲存方法的形式是：
        ...
        @Ball:「Class內能儲存什麼?」
        @Answer:方法或者變量`);
Part.gr = Object.freeze(`@Ball:構造函數用於創建一個class的實例
        @Ball:把class當作是一個模板
...
Part._method = Object.freeze(`@Ball:方法（method）就是程式中用來解決重複問題的工具
        ...
        @Code:q1
        @Answer:true`);
Part._abstract = Object.freeze(`@Ball:對於子類可以重寫父類邏輯
        ...
        @Ball:「abstract只能用來?」
        @Answer:修飾方法`);
Part.rg = Object.freeze(`@Ball:在程式語言中，「權限」就像是一個管理誰能做什麼事情的規則。
        @Ball:default（預設權限）：
        ...
        @Code:q1
        @Answer:false`);
Part.gh = Object.freeze(`@Ball:public（公共權限）：
        @Ball:這是完全沒有限制的權限
        @Ball:任何人都可以使用或修改資料。
        ...
        @Code:q1
        @Answer:true`);
Part.lp = Object.freeze(`@Ball:private（私有權限）：
        ...
        @Code:q1
        @Answer:false`);
Part.po = Object.freeze(`@Ball:protected（保護權限）：
