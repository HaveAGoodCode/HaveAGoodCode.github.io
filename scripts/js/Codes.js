...
Codes.earthHaveWaterTrue = `
    boolean earthHaveWater = true;`;
Codes.earthHaveWaterFalse = `
    earthHaveWater = false;`;
Codes.finalEarthHaveWaterTrue = `
...
Codes.abstractBeforeOverride = `
    abstract class Animal {
        abstract int method();
    }
    class Dog extends Animal {}`;
Codes.abstractAfterOverride = `
    abstract class Animal {
        abstract int method();
    }
    class Dog extends Animal {
